...
(function () {
	$(document).ready(function () {
		...
		d3.csv("test-data/tennisdataset.csv", function(error, tennis) {
			//console.log(tennis);
			if (error) {
			...
			*/
			...
			console.log("The dataset", tennis);
			...
			console.log("filter by males", Agg.filter(winCount, ["Gender", "Count"], ["Male", 15]));
